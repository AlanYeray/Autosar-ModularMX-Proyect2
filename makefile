...
SRCS  = main.c 
#Mcal Modules to use
MCAL_SRCS = Platform Base Rte Mcu Port Dio Bfx Gpt Adc  Pwm
#BSW Modules to use
...
SRC_PATHS += Autosar/Mcal/Base/src
SRC_PATHS += Autosar/Bfx/src
SRC_PATHS += Autosar/IoHwAbs/src
