...
#define SIZE_HASH_DINAMIC 29
#define SIZE_DIO 13
#define SIZE_PORT_HASH 17
#define SIZE_HASH 2

    typedef struct _HashTableDinamic
    {
        uint8 key;
        char *value;
        uint8 ApiId;
    ...
    typedef struct _HashTable
    {
        ...
        uint8 InstanceId;
        char *cInstance;
    } DefaultErrorTrace_static;


    // SWS_Port_00051 Error classification
